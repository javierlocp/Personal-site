      ...
      <ul>
        {posts.map((post) => (
          <li key={post.slug} className="my-2">
            ...
            >
              <div className="flex items-center justify-between gap-4 md:gap-4 md:gap-8">
                <h2 className="max-w-[250px] truncate md:max-w-[400px]">{post.title}</h2>
              ...
              <span className="block max-w-[250px] truncate text-neutral-400 md:max-w-[400px]">{post.description}</span>
            </a>
          </li>
        ))}
      </ul>
